    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-purple-50/30 p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Sign in to your Design.ly account</p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm text-designly-purple-600 hover:text-designly-purple-700 font-medium"
                >
                  Forgot password?
                </Link>
              </div>
